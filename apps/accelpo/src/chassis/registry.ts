 ...
 * and CP-08 RFx bridge boundaries registered. Later parts should add themselves through the same
 * registry rather than creating another router, command boundary, query service, policy engine,
 * or supplier marketplace.
 */
