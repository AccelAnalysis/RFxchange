...
export async function MarketingHeader() {
  ...
  const navigation = [
    ...
    { href: "/membership", label: dictionary.marketingPages.founding.comparison.eyebrow },
    ...
    <footer className={styles.footer}>
      <div className={styles.footerGrid}>
        ...
        <div className={styles.footerCol}>
          ...
          <Link href="/membership">{dictionary.marketingPages.founding.comparison.eyebrow}</Link>
        ...
        <div className={styles.footerCol}>
          ...
          <Link href="/sms">SMS updates</Link>
