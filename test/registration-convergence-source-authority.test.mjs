...
test("registration convergence remains aligned across runtime and canonical authorities", async () => {
  ...
  assert.ok(tracker.includes("37/43 Activation"));
  ...
  assert.ok(
    providerBrief.includes(
      "Official Resource Provider is a separately applied-for, administratively approved organization status",
    ),
  );
