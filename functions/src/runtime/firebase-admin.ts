...
let functionsAuth: Auth | null = null;
...
export function getFunctionsAuth(): Auth {
  if (functionsAuth) return functionsAuth;
  functionsAuth = getAuth(getFunctionsAdminApp());
  return functionsAuth;
}
