...
assert.match(workspace, /viewMode: "2d"/);
assert.match(workspace, /pitch: 0/);
assert.match(workspace, /bearing: 0/);
...
console.log("Slice 3.2 controlled Network discovery validated with marker-context actions, restrained empty states, quiet default 2D map state, and simplified participant language.");
