...
assert.ok(
  roadmap.includes("Brand Gate B1 — Semantic design foundation — COMPLETE IN PR #109") &&
    ...
    roadmap.includes("Slice 3.8 is separately authorized"),
  "Brand B1 semantic authority must remain intact through completed B2–B6a, the AMACS/AI foundations, accepted Slice 3.7, and authorized Slice 3.8.",
);
...
console.log(
  "Brand Gate B1 semantic foundation validated through B6a, accepted Slice 3.7, and authorized Slice 3.8: exact palette, accessible gold text, Exchange Light roles, compatibility aliases, object semantics, motion/type/layout tokens, and drift controls.",
);
