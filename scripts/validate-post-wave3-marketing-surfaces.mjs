...
const home = read("apps/marketing/app/page.tsx");
const founding = read("apps/marketing/app/founding/page.tsx");
const foundersRedirect = read("apps/marketing/app/founders/page.tsx");
const availability = read("apps/marketing/components/MarketingAvailability.tsx");
const marketing = read("src/content/marketing.ts");
const chrome = read("apps/marketing/components/MarketingChrome.tsx");
const responsiveChrome = read("apps/marketing/components/MarketingChromeResponsive.module.css");
