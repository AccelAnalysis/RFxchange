...
assert.match(authority, /Slice 3\.5 and all later slices\/gates remain unstarted/);
assert.match(slice, /IMPLEMENTED AND ACCEPTED/);
assert.match(tracker, /438 total · 132 Done · 306 Not Started/);
assert.match(tracker, /Network completion is \*\*18\/38\*\*/);
