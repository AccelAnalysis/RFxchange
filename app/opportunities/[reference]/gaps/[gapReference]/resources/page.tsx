...
export default async function OpportunityGapResourcesPage({ params, searchParams }: Readonly<{ params: Promise<{ reference: string; gapReference: string }>; searchParams?: Promise<Readonly<Record<string, string | string[] | undefined>>> }>) {
  ...
  redirect(service.resourceHref(context, returnTo));
}
