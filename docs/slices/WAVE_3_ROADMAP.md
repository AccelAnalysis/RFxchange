...
| **3.4 — Credential, Media & Location Enrichment** | `ORG-015`, `ORG-018`, `ORG-019` | **Authorized; single active slice.** Credentials with provenance; private-by-default media, documents and portfolio; subordinate additional locations with geography and privacy authority. |
...
- Slice 3.4 is the single active authorized slice; Slice 3.5 and later work remain unstarted.
