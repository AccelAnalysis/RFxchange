# Wave 1 Slice 1.30 — Controlled user administration

## Scope

This slice implements **ADM-068 — Controlled user administration actions**.
...
- the Wave 2 organization claims console (`ADM-065`);
