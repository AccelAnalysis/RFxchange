...
9. **Slice 1.30 — `ADM-068`**: controlled user administration actions.
10. **Slice 1.31 — `COM-038`**: payment-provider abstraction foundation, subject to dependency recalculation after 1.30 merges.
