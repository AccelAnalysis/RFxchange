...
- card/map/keyboard detail entry, deep-link pre-authorization isolation, affirmative resolution, coherent nondisclosing denial while opening or already open, complete focal/association/relationship/marker return-selection binding, explicit return-context authorization, independent list/sheet restoration, exact snap-point restoration, lens-discriminated safe returns, and stale-scope discard;
...
Implementation PR #231 records candidate `0b6b0999afe592725cd0a81a27f14b221f8c82b4`, successful exact-head CI run `32103926126`, merge `5ddca57bf2d9fa2c81a98e75aeee09302d278a23`, and post-merge run `32104375075`. Authorization-correction PR #233 records final corrected candidate `15e7c2333d1e9113055630bf256f977f7c39d080`, successful exact-head CI `32106236531`, merge `3830577e14b7b1bc6878965d26369529de2ebbbb`, and post-merge run `32106855995`. Control Room binds the query/detail requirements to the corrected candidate, preserves map/result implementation provenance, records the four `Implemented — Not Verified` dispositions and denominator arithmetic, and activates dependency-safe next packets without changing the Feature-ID tracker.
...
- Every accepted discovery response carries all four explicit authorization booleans and exact scope/lens/locale/geography/query/result-set binding. A carried selection additionally requires an exact non-null focal identity, and every opening or open detail requires an exact identity plus canonical destination; omitted facts fail rather than default to allowed. Detail close requires separate explicit results for the detail, return context, focal subject, associated organization, and relationship, plus a complete server-revalidated selection; restoration requires exact agreement across the focal identity, organization/record context, marker, and relationship.
