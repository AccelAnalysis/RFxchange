...
- card/map/keyboard detail entry, deep-link pre-authorization isolation, affirmative resolution, nondisclosing denial while opening or already open, separately revalidated return-snapshot selection, independent list/sheet restoration, exact snap-point restoration, lens-discriminated safe returns, and stale-scope discard;
