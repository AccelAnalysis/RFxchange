...
const DEFINITIONS: readonly ExchangeRoomActionDefinition[] = Object.freeze([
  ...
  Object.freeze({ id: "resources.find-providers", lens: "resources", order: 1, canonicalLabel: "Find Providers", labelKey: "networkWorkspace.exchangeRoom.actions.resources.findProviders", operational: true, applicability: "any", authorization: "open-platform-referral-manage", handler: "resource-discovery" }),
  Object.freeze({ id: "resources.browse-resources", lens: "resources", order: 2, canonicalLabel: "Browse Resources", labelKey: "networkWorkspace.exchangeRoom.actions.resources.browseResources", operational: true, applicability: "any", authorization: "open-platform-referral-manage", handler: "resource-browse" }),
  ...
  Object.freeze({ id: "referrals.new", lens: "referrals", order: 1, canonicalLabel: "New Referral", labelKey: "networkWorkspace.exchangeRoom.actions.referrals.new", operational: false, applicability: "any", authorization: "open-platform-referral-manage", handler: null }),
...
function applicable(definition: ExchangeRoomActionDefinition, input: ExchangeRoomActionProjectionInput): boolean {
  if (definition.applicability === "viewer-organization") return input.viewerOrganizationId === input.selectedOrganizationId;
