...
export const ADMIN_DOMAIN_SURFACES: Readonly<Record<AdminDomainSurfaceKey, AdminDomainSurfaceDefinition>> = Object.freeze({
  ...
  "users-access": Object.freeze({
    ...
    titleFields: Object.freeze(["displayName", "name", "email"]), subtitleFields: Object.freeze(["email", "userId"]), statusFields: Object.freeze(["status", "accountStatus"]),
    searchFields: Object.freeze(["displayName", "name", "email", "userId", "id"]),
    facts: Object.freeze([F("User", "userId"), F("Email", "email"), F("Created", "createdAt"), F("Updated", "updatedAt")]),
  ...
  "claims-verification": Object.freeze({
    ...
    titleFields: Object.freeze(["displayName", "credentialType", "claimType", "organizationId"]), subtitleFields: Object.freeze(["organizationId", "claimantUserId", "issuer"]),
    statusFields: Object.freeze(["status", "state", "verificationStatus"]), searchFields: Object.freeze(["organizationId", "claimantUserId", "credentialType", "claimType", "issuer", "status"]),
  ...
  geographies: Object.freeze({
    ...
    titleFields: Object.freeze(["displayName", "name", "label"]), subtitleFields: Object.freeze(["type", "geographyType", "fips"]), statusFields: Object.freeze(["releaseState", "participationState", "status"]),
    searchFields: Object.freeze(["displayName", "name", "label", "fips", "type", "geographyType", "id"]),
    facts: Object.freeze([F("Type", "type", "geographyType"), F("FIPS", "fips"), F("Release", "releaseState"), F("Boundary version", "boundaryVersion", "geometryVersion")]),
  ...
  "institutions-partners": Object.freeze({
    ...
    titleFields: Object.freeze(["institutionName", "organizationName", "programName", "organizationId"]), subtitleFields: Object.freeze(["geographyId", "programId", "organizationId"]), statusFields: Object.freeze(["status", "state"]),
    searchFields: Object.freeze(["institutionName", "organizationName", "programName", "organizationId", "geographyId", "programId"]),
    facts: Object.freeze([F("Organization", "organizationId"), F("Geography", "geographyId"), F("Program", "programId", "programName"), F("Authority", "authority", "permission")]),
  ...
  "rfx-opportunities": Object.freeze({
    ...
    titleFields: Object.freeze(["title", "name", "rfxNumber"]), subtitleFields: Object.freeze(["issuerOrganizationId", "organizationId", "rfxNumber"]), statusFields: Object.freeze(["status", "lifecycle", "publicationStatus"]),
    searchFields: Object.freeze(["title", "name", "rfxNumber", "issuerOrganizationId", "organizationId", "id"]),
    facts: Object.freeze([F("Issuer", "issuerOrganizationId", "organizationId"), F("Geography", "geographyId", "performanceGeographyId"), F("Deadline", "deadline", "responseDeadline"), F("Updated", "updatedAt")]),
  ...
  "referrals-teaming": Object.freeze({
    ...
    titleFields: Object.freeze(["title", "referralNumber", "recipientName"]), subtitleFields: Object.freeze(["senderOrganizationId", "recipientOrganizationId", "opportunityId"]), statusFields: Object.freeze(["status", "state"]),
    searchFields: Object.freeze(["referralNumber", "senderOrganizationId", "recipientOrganizationId", "opportunityId", "recipientEmail", "id"]),
    facts: Object.freeze([F("Sender", "senderOrganizationId"), F("Recipient", "recipientOrganizationId", "recipientEmail"), F("Opportunity", "opportunityId", "rfxId"), F("Updated", "updatedAt")]),
  ...
  "trust-safety": Object.freeze({
    ...
    titleFields: Object.freeze(["reason", "type", "state"]), subtitleFields: Object.freeze(["organizationId", "userId", "membershipId"]), statusFields: Object.freeze(["state", "status"]),
    searchFields: Object.freeze(["reason", "type", "state", "organizationId", "userId", "membershipId", "id"]),
    facts: Object.freeze([F("Organization", "organizationId"), F("User", "userId"), F("State", "state", "status"), F("Effective", "effectiveAt", "createdAt")]),
  ...
  "audit-security": Object.freeze({
    ...
    titleFields: Object.freeze(["action", "eventType", "id"]), subtitleFields: Object.freeze(["administratorId", "permission", "scope"]), statusFields: Object.freeze(["outcome", "sensitivity"]),
    searchFields: Object.freeze(["administratorId", "action", "eventType", "permission", "scope", "outcome", "relatedCaseId", "id"]),
    facts: Object.freeze([F("Administrator", "administratorId"), F("Permission", "permission"), F("Outcome", "outcome"), F("Recorded", "recordedAt", "createdAt")]),
