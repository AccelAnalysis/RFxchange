...
> = Object.freeze({
  organizations: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizations, documentIdSource: "id", scope: "organization-root", organizationIdRequired: false, appendOnly: false, mutable: true }),
  organizationProfiles: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationProfiles, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  organizationDiscoveryRecords: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationDiscoveryRecords, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  organizationAuthorityClaims: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationAuthorityClaims, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  organizationLocationDrafts: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationLocationDrafts, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  organizationLocations: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationLocations, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  organizationServiceGeographies: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationServiceGeographies, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  organizationProfileCompletions: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationProfileCompletions, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  organizationMarkerActivations: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationMarkerActivations, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  users: Object.freeze({ collection: FIRESTORE_COLLECTIONS.users, documentIdSource: "id", scope: "user-scoped", organizationIdRequired: false, appendOnly: false, mutable: true }),
  organizationMemberships: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationMemberships, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  organizationAuthorizations: Object.freeze({ collection: FIRESTORE_COLLECTIONS.organizationAuthorizations, documentIdSource: "membershipId", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  geographies: Object.freeze({ collection: FIRESTORE_COLLECTIONS.geographies, documentIdSource: "id", scope: "platform-scoped", organizationIdRequired: false, appendOnly: false, mutable: true }),
  primaryGeographySelections: Object.freeze({ collection: FIRESTORE_COLLECTIONS.primaryGeographySelections, documentIdSource: "userId", scope: "user-scoped", organizationIdRequired: false, appendOnly: false, mutable: true }),
  geographyParticipationAuthorizations: Object.freeze({ collection: FIRESTORE_COLLECTIONS.geographyParticipationAuthorizations, documentIdSource: "id", scope: "mixed-scope", organizationIdRequired: false, appendOnly: false, mutable: true }),
  accessJourneys: Object.freeze({ collection: FIRESTORE_COLLECTIONS.accessJourneys, documentIdSource: "id", scope: "platform-scoped", organizationIdRequired: false, appendOnly: false, mutable: true }),
  accessRestrictions: Object.freeze({ collection: FIRESTORE_COLLECTIONS.accessRestrictions, documentIdSource: "id", scope: "mixed-scope", organizationIdRequired: false, appendOnly: false, mutable: true }),
  ...
  adminAuthorityContexts: Object.freeze({ collection: FIRESTORE_COLLECTIONS.adminAuthorityContexts, documentIdSource: "administratorId", scope: "platform-scoped", organizationIdRequired: false, appendOnly: false, mutable: true }),
  ...
  acquisitionContexts: Object.freeze({ collection: FIRESTORE_COLLECTIONS.acquisitionContexts, documentIdSource: "id", scope: "mixed-scope", organizationIdRequired: false, appendOnly: false, mutable: true }),
  ...
  opportunityFitSnapshots: Object.freeze({ collection: FIRESTORE_COLLECTIONS.opportunityFitSnapshots, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: true, mutable: false }),
  opportunityPursuits: Object.freeze({ collection: FIRESTORE_COLLECTIONS.opportunityPursuits, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  opportunityPursuitCommands: Object.freeze({ collection: FIRESTORE_COLLECTIONS.opportunityPursuitCommands, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: true, mutable: false }),
  opportunityPursuitEvents: Object.freeze({ collection: FIRESTORE_COLLECTIONS.opportunityPursuitEvents, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: true, mutable: false }),
  ...
  orientationJourneys: Object.freeze({ collection: FIRESTORE_COLLECTIONS.orientationJourneys, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
  ...
  firstValueSelections: Object.freeze({ collection: FIRESTORE_COLLECTIONS.firstValueSelections, documentIdSource: "id", scope: "organization-scoped", organizationIdRequired: true, appendOnly: false, mutable: true }),
