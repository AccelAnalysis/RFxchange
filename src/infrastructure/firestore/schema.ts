...
export const FIRESTORE_COLLECTIONS = {
  ...
  primaryOperatingGeographySelections: "primaryOperatingGeographySelections",
...
> = Object.freeze({
  ...
  primaryOperatingGeographySelections: Object.freeze({
    collection: FIRESTORE_COLLECTIONS.primaryOperatingGeographySelections,
    documentIdSource: "id",
    scope: "user-scoped",
    organizationIdRequired: false,
    appendOnly: false,
