...
export const SAD_RUNTIME_COLLECTIONS = Object.freeze({
  ...
  communicationSupportHolds: { scope: "user", mutable: true },
  communicationUnsubscribeTokens: { scope: "user", mutable: true },
  ...
  marketingCampaigns: { scope: "platform", mutable: true },
  marketingAttribution: { scope: "user", mutable: true },
